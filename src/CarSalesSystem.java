...
public class CarSalesSystem extends JFrame implements ActionListener, ComponentListener
{
	...
	private JLabel carCoLabel = new JLabel("welcome to our Vehicle Shop", JLabel.CENTER);
	private JLabel salesSysLabel = new JLabel("Here you can buy or sell vehicles", JLabel.CENTER);
	...
	public CarSalesSystem(String f)
	{
		...
		pictureLabel.setIcon(new ImageIcon("vehicle.png"));
